...
{"version":3,"file":"index.d.ts","sourceRoot":"","sources":["index.ts"],"names":[],"mappings":"AAAA,MAAM,CAAC,MAAM,UAAU,EAAE,MAAsB,CAAC;AAChD,MAAM,UAAU,OAAO,CAAC,CAAC,EAAE,MAAM,EAAE,CAAC,EAAE,MAAM,UAAmB;AAC/D,MAAM,UAAU,QAAQ,CAAC,CAAC,EAAE,MAAM,EAAE,CAAC,EAAE,MAAM,UAAmB;AAChE,MAAM,OAAO,SAAS;CAAI"}
...
//// [/user/username/projects/sample1/core/tsconfig.tsbuildinfo.readable.baseline.txt] *modified* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "950ea6f2921c85d020a92f89f772b33f-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\n",
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "ce98c7b232474711a6089b586825cf2a-export const someString: string = \"HELLO WORLD\";\nexport function leftPad(s: string, n: number) { return s + n; }\nexport function multiply(a: number, b: number) { return a * b; }\nexport class someClass { }",
        "signature": "950ea6f2921c85d020a92f89f772b33f-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\n",
...
{"version":"FakeTSVersion","root":[4],"fileNames":["lib.es2025.full.d.ts","../core/index.d.ts","../core/anotherModule.d.ts","./index.ts"],"fileInfos":[{"version":"8859c12c614ce56ba9a18e58384a198f-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},"b2505e2ff9342aa73836b8613becc8db-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\n//# sourceMappingURL=index.d.ts.map","3f5e1b83e1f23661cbe360ada7cfab65-export const World = \"hello\";\n//# sourceMappingURL=anotherModule.d.ts.map",{"version":"590556060bc156a64834010df8cda255-import * as c from '../core/index';\nexport function getSecondsInDay() {\n    return c.multiply(10, 15);\n}\nimport * as mod from '../core/anotherModule';\nexport const m = mod;","signature":"e8586ca83951b76a5a06f37a66ecfc5e-export function getSecondsInDay(): number;\nimport * as mod from '../core/anotherModule';\nexport const m: typeof mod;\n","impliedNodeFormat":1}],"fileIdsList":[[2,3]],"options":{"composite":true,"declaration":true,"skipDefaultLibCheck":true,"sourceMap":true},"referencedMap":[[4,1]],"latestChangedDtsFile":"./index.d.ts"}
//// [/user/username/projects/sample1/logic/tsconfig.tsbuildinfo.readable.baseline.txt] *modified* 
{
  ...
  "fileInfos": [
    ...
    {
      "fileName": "../core/index.d.ts",
      "version": "b2505e2ff9342aa73836b8613becc8db-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\n//# sourceMappingURL=index.d.ts.map",
      "signature": "b2505e2ff9342aa73836b8613becc8db-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\n//# sourceMappingURL=index.d.ts.map",
      "impliedNodeFormat": "CommonJS"
    },
    {
      "fileName": "../core/anotherModule.d.ts",
...
//# sourceMappingURL=index.d.ts.map
//// [/user/username/projects/sample1/core/index.d.ts.map] *modified* 
{"version":3,"file":"index.d.ts","sourceRoot":"","sources":["index.ts"],"names":[],"mappings":"AAAA,MAAM,CAAC,MAAM,UAAU,EAAE,MAAsB,CAAC;AAChD,MAAM,UAAU,OAAO,CAAC,CAAC,EAAE,MAAM,EAAE,CAAC,EAAE,MAAM,UAAmB;AAC/D,MAAM,UAAU,QAAQ,CAAC,CAAC,EAAE,MAAM,EAAE,CAAC,EAAE,MAAM,UAAmB;AAChE,MAAM,OAAO,SAAS;CAAI;AAC1B,MAAM,OAAO,UAAU;CAAI"}
//// [/user/username/projects/sample1/core/index.js] *modified* 
export const someString = "HELLO WORLD";
export function leftPad(s, n) { return s + n; }
export function multiply(a, b) { return a * b; }
...
//// [/user/username/projects/sample1/core/tsconfig.tsbuildinfo.readable.baseline.txt] *modified* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "17c7313b9c12d50841ae34e2ce5b1334-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\nexport class someClass2 {\n}\n",
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "3682101db2184c6bccaa98c1c1ac0791-export const someString: string = \"HELLO WORLD\";\nexport function leftPad(s: string, n: number) { return s + n; }\nexport function multiply(a: number, b: number) { return a * b; }\nexport class someClass { }\nexport class someClass2 { }",
        "signature": "17c7313b9c12d50841ae34e2ce5b1334-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\nexport class someClass2 {\n}\n",
...
//// [/user/username/projects/sample1/logic/index.js.map] *rewrite with same content*
//// [/user/username/projects/sample1/logic/tsconfig.tsbuildinfo] *modified* 
{"version":"FakeTSVersion","root":[4],"fileNames":["lib.es2025.full.d.ts","../core/index.d.ts","../core/anotherModule.d.ts","./index.ts"],"fileInfos":[{"version":"8859c12c614ce56ba9a18e58384a198f-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},"81713af6164fe07530d0bbba7e5b8cbf-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\nexport class someClass2 {\n}\n//# sourceMappingURL=index.d.ts.map","3f5e1b83e1f23661cbe360ada7cfab65-export const World = \"hello\";\n//# sourceMappingURL=anotherModule.d.ts.map",{"version":"590556060bc156a64834010df8cda255-import * as c from '../core/index';\nexport function getSecondsInDay() {\n    return c.multiply(10, 15);\n}\nimport * as mod from '../core/anotherModule';\nexport const m = mod;","signature":"e8586ca83951b76a5a06f37a66ecfc5e-export function getSecondsInDay(): number;\nimport * as mod from '../core/anotherModule';\nexport const m: typeof mod;\n","impliedNodeFormat":1}],"fileIdsList":[[2,3]],"options":{"composite":true,"declaration":true,"skipDefaultLibCheck":true,"sourceMap":true},"referencedMap":[[4,1]],"latestChangedDtsFile":"./index.d.ts"}
//// [/user/username/projects/sample1/logic/tsconfig.tsbuildinfo.readable.baseline.txt] *modified* 
{
  "version": "FakeTSVersion",
  "root": [
  ...
  "fileInfos": [
    ...
    {
      "fileName": "../core/index.d.ts",
      "version": "81713af6164fe07530d0bbba7e5b8cbf-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\nexport class someClass2 {\n}\n//# sourceMappingURL=index.d.ts.map",
      "signature": "81713af6164fe07530d0bbba7e5b8cbf-export const someString: string;\nexport function leftPad(s: string, n: number): string;\nexport function multiply(a: number, b: number): number;\nexport class someClass {\n}\nexport class someClass2 {\n}\n//# sourceMappingURL=index.d.ts.map",
      "impliedNodeFormat": "CommonJS"
    },
    {
      "fileName": "../core/anotherModule.d.ts",
