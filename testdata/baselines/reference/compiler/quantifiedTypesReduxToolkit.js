...
//// [quantifiedTypesReduxToolkit.js]
// https://github.com/microsoft/TypeScript/issues/51612#issuecomment-1375431039
const slice = createSlice({
    name: "someSlice",
    initialState: {
...
{
    const _expectType = slice.actions.simpleReducer;
}
{
    const _expectType = slice.actions.reducerWithPrepareNotation;
}
{
    const _expectType = slice.actions.reducerWithAnotherPrepareNotation;
}
