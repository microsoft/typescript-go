...
function takeReturnString(str: string): string;
function takeReturnHello(str: "Hello"): "Hello";
function takeReturnHelloWorld(str: "Hello" | "World"): "Hello" | "World";
function fun1<T>(x: T, y: T): T;
