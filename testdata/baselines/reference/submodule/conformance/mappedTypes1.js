...
function f2<T1 extends string>(): {
    [P in keyof T1]: void;
};
function f3<T1 extends number>(): {
    [P in keyof T1]: void;
};
function f4<T1 extends Number>(): {
    [P in keyof T1]: void;
};
let x1: {};
let x2: string;
...
mappedTypes1.d.ts(75,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== mappedTypes1.d.ts (1 errors) ====
    type Item = {
        a: string;
        b: number;
        c: boolean;
