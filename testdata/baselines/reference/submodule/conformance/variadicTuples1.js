...
const t2: readonly [1, string, 2, number, boolean, 3];
function concat<T extends unknown[], U extends unknown[]>(t: [...T], u: [...U]): [...T, ...U];
const sa: string[];
const tc1: [];
const tc2: [string, number];
const tc3: [number, number, number, ...string[]];
const tc4: [...string[], number, number, number];
function concat2<T extends readonly unknown[], U extends readonly unknown[]>(t: T, u: U): (T[number] | U[number])[];
const tc5: (1 | 2 | 3 | 4 | 5 | 6)[];
function foo1(a: number, b: string, c: boolean, ...d: number[]): void;
function foo2(t1: [number, string], t2: [boolean], a1: number[]): void;
function foo3<T extends unknown[]>(x: number, ...args: [...T, number]): T;
function foo4<U extends unknown[]>(u: U): void;
function ft1<T extends unknown[]>(t: T): T;
function ft2<T extends unknown[]>(t: T): readonly [...T];
function ft3<T extends unknown[]>(t: [...T]): T;
function ft4<T extends unknown[]>(t: [...T]): readonly [...T];
...
function fm1<T extends unknown[]>(t: Arrayify<[string, number, ...T]>): T;
let tm1: [boolean, string];
function fx1<T extends unknown[]>(a: string, ...args: T): T;
function gx1<U extends unknown[], V extends readonly unknown[]>(u: U, v: V): void;
function fx2<T extends readonly unknown[]>(a: string, ...args: T): T;
...
const fn1: (a: number, b: string, c: boolean, d: string[]) => number;
const c0: (a: number, b: string, c: boolean, d: string[]) => number;
const c1: (b: string, c: boolean, d: string[]) => number;
const c2: (c: boolean, d: string[]) => number;
const c3: (d: string[]) => number;
const c4: () => number;
const fn2: (x: number, b: boolean, ...args: string[]) => number;
const c10: (x: number, b: boolean, ...args: string[]) => number;
const c11: (b: boolean, ...args: string[]) => number;
const c12: (...b: string[]) => number;
const c13: (...b: string[]) => number;
const fn3: (...args: string[]) => number;
const c20: (...b: string[]) => number;
const c21: (...b: string[]) => number;
const c22: (...b: string[]) => number;
function curry2<T extends unknown[], U extends unknown[], R>(f: (...args: [...T, ...U]) => R, t: [...T], u: [...U]): R;
function fn10(a: string, b: number, c: boolean): string[];
function ft<T extends unknown[]>(t1: [...T], t2: [...T, number?]): T;
function call<T extends unknown[], R>(...args: [...T, (...args: T) => R]): [T, R];
function f20<T extends unknown[] = []>(args: [...T, number?]): T;
function f21<U extends string[]>(args: [...U, number?]): void;
function f22<T extends unknown[] = []>(args: [...T, number]): T;
function f22<T extends unknown[] = []>(args: [...T]): T;
function f23<U extends string[]>(args: [...U, number]): void;
interface Desc<A extends unknown[], T> {
    readonly f: (...args: A) => T;
    bind<T extends unknown[], U extends unknown[], R>(this: Desc<[...T, ...U], R>, ...args: T): Desc<[...U], R>;
}
const a: Desc<[string, number, boolean], object>;
const b: Desc<[boolean], object>;
function getUser(id: string, options?: {
    x?: string;
}): string;
function getOrgUser(id: string, orgId: number, options?: {
    y?: number;
    z?: boolean;
}): void;
function callApi<T extends unknown[] = [], U = void>(method: (...args: [...T, object]) => U): (...args: [...T]) => U;
type Numbers = number[];
type Unbounded = [...Numbers, boolean];
const data: Unbounded;
type U1 = [string, ...Numbers, boolean];
type U2 = [...[string, ...Numbers], boolean];
type U3 = [...[string, number], boolean];
type ToStringLength1<T extends any[]> = `${T['length']}`;
