...
function f01(x: unknown): void;
function f02(x: string | undefined): void;
function f03(x: string | undefined, assert: (value: unknown) => asserts value): void;
namespace Debug {
    function assert(value: unknown, message?: string): asserts value;
    function assertDefined<T>(value: T): asserts value is NonNullable<T>;
}
function f10(x: string | undefined): void;
class Test {
    assert(value: unknown): asserts value;
    isTest2(): this is Test2;
    assertIsTest2(): asserts this is Test2;
...
function f11(items: Test[]): void;
let Q1: new (x: unknown) => x is string;
let Q2: new (x: boolean) => asserts x;
let Q3: new (x: unknown) => asserts x is string;
class Wat {
    get p1(): this is string;
    set p1(x: this is string);
    get p2(): asserts this is string;
...
function example1(things: Thing[]): void;
class TestPropertyDeclaration1 {
    assert: (value: unknown) => asserts value;
...
class ParentInheritedPropertyDeclaration {
    assert: (value: unknown) => asserts value;
}
class ChildInheritedPropertyDeclaration extends ParentInheritedPropertyDeclaration {
    other(x: unknown): void;
...
function testPropertySignature(x: TestPropertySignature, y: unknown): void;
function testFunctionThisParameter1(this: TestPropertySignature, x: unknown): void;
interface TestMethodSignature {
    assert(value: unknown): asserts value;
}
function testMethodSignature(x: TestMethodSignature, y: unknown): void;
function testFunctionThisParameter2(this: TestMethodSignature, x: unknown): void;
