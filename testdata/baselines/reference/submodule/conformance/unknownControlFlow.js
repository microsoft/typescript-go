...
function f12<T extends {}>(x: T): void;
function f20(x: unknown): void;
function f21<T>(x: T): void;
function f22<T extends {} | undefined>(x: T): void;
function f23<T>(x: T | undefined | null): void;
function f30(x: {}): void;
function f31<T>(x: T): void;
function f32<T extends {} | undefined>(x: T): void;
...
function ensureNotNull<T>(x: T): T & ({} | undefined);
function ensureNotUndefined<T>(x: T): T & ({} | null);
function ensureNotNullOrUndefined<T>(x: T): T & {};
...
function ff2<T>(t: T & {}, k: keyof T): void;
function ff3<T>(t: T, k: keyof (T & {})): void;
function ff4<T>(t: T & {}, k: keyof (T & {})): void;
type Foo = {
    [key: string]: unknown;
};
type NullableFoo = Foo | undefined;
type Bar<T extends NullableFoo> = NonNullable<T>[string];
function fx0<T>(value: T & ({} | null)): void;
function fx1<T extends unknown>(value: T & ({} | null)): void;
function fx2<T extends {}>(value: T & ({} | null)): void;
function fx3<T extends {} | undefined>(value: T & ({} | null)): void;
function fx4<T extends {} | null>(value: T & ({} | null)): void;
function fx5<T extends {} | null | undefined>(value: T & ({} | null)): void;
...
type AB = "A" | "B";
function x<T_AB extends AB>(x: T_AB & undefined, y: any): void;
type Left = 'left';
type Right = 'right' & {
    right: 'right';
};
type Either = Left | Right;
function assertNever(v: never): never;
function fx20(value: Either): void;
