...
const t1: [number, boolean, string];
function f1(cb: (...args: typeof t1) => void): void;
const t2: [number, boolean, ...string[]];
function f2(cb: (...args: typeof t2) => void): void;
const t3: [boolean, ...string[]];
function f3(cb: (x: number, ...args: typeof t3) => void): void;
function f4<T extends any[]>(t: T): void;
function f5<T extends any[], U>(f: (...args: T) => U): (...args: T) => U;
let g0: () => string;
let g1: (x: any, y: any) => number;
let g2: (x: number, y: any) => number;
let g3: (x: number, y: number) => number;
let g4: (...args: any[]) => boolean;
function pipe<A extends any[], B, C>(f: (...args: A) => B, g: (x: B) => C): (...args: A) => C;
let g5: () => number;
let g6: (x: any) => number;
let g7: (x: any, y: any) => string;
let g8: (x: number, y: string) => string;
var tuple: [number, string];
function take(cb: (a: number, b: string) => void): void;
type ArgsUnion = [number, string] | [number, Error];
type TupleUnionFunc = (...params: ArgsUnion) => number;
const funcUnionTupleNoRest: TupleUnionFunc;
const funcUnionTupleRest: TupleUnionFunc;
