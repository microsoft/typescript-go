...
let tt1: [...string[], number];
function ft1(...args: [...strs: string[], num: number]): void;
let tt2: [number, ...string[], number];
function ft2(n1: number, ...rest: [...strs: string[], n2: number]): void;
function ft3<T extends unknown[]>(x: [number, ...T], y: [number, number], z: [number, ...number[]]): void;
let tt3: [number, string, ...any[]];
let tt4: [number, ...number[]];
function pipe<T extends readonly unknown[]>(...args: [...T, (...values: T) => void]): void;
const sa: string[];
function fn1<T, U>(t: [...unknown[], T, U]): [T, U];
function fn2<T, U>(t: [T, ...unknown[], U]): [T, U];
function foo<S extends readonly [string, ...string[]]>(...stringsAndNumber: readonly [...S, number]): [...S, number];
const a1: ["blah1", number];
const b1: ["blah1", "blah2", number];
const c1: [string, ...string[], number];
const d1: [string, ...string[], number];
const e1: [string, ...string[], number];
