...
_A_foo = new WeakMap(), _A_bar = new WeakMap(), _A_baz = new WeakMap(), _A_qux = new WeakMap(), _A_instances = new WeakSet(), _A_fooMethod = function _A_fooMethod() { return 3; } // Error
, _A_barMethod = function _A_barMethod() { return 3; } // Error
, _A_bazMethod = function _A_bazMethod() { return 3; } // Error
, _A_quxMethod = function _A_quxMethod() { return 3; } // Error
, _A_asyncMethod = function _A_asyncMethod() {
    return __awaiter(this, void 0, void 0, function* () { return 1; });
} //OK
, _A_genMethod = function* _A_genMethod() { return 1; } //OK
, _A_asyncGenMethod = function _A_asyncGenMethod() { return __asyncGenerator(this, arguments, function* _A_asyncGenMethod_1() { return yield __await(1); }); } //OK
, _A_fooProp_get = function _A_fooProp_get() { return 3; } // Error
, _A_fooProp_set = function _A_fooProp_set(value) { } // Error
, _A_barProp_get = function _A_barProp_get() { return 3; } // Error
, _A_barProp_set = function _A_barProp_set(value) { } // Error
, _A_bazProp_get = function _A_bazProp_get() { return 3; } // Error
, _A_bazProp_set = function _A_bazProp_set(value) { } // Error
, _A_quxProp_get = function _A_quxProp_get() { return 3; } // Error
, _A_quxProp_set = function _A_quxProp_set(value) { } // Error
, _A_whatProp_get = function _A_whatProp_get() { }, _A_whatProp_set = function _A_whatProp_set(value) { }, _A_asyncProp_get = function _A_asyncProp_get() {
    return __awaiter(this, void 0, void 0, function* () { return 1; });
} // Error
