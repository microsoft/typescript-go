...
function f1<A, B extends A>(a: Covariant<A>, b: Covariant<B>): void;
function f2<A, B extends A>(a: Contravariant<A>, b: Contravariant<B>): void;
function f3<A, B extends A>(a: Invariant<A>, b: Invariant<B>): void;
function isFunction<T>(value: T): value is Extract<T, Function>;
function getFunction<T>(item: T): Extract<T, Function>;
function f10<T>(x: T): void;
function f11(x: string | (() => string) | undefined): void;
function f12(x: string | (() => string) | undefined): void;
type Foo = {
    foo: string;
};
type Bar = {
...
type Extract2<T, U, V> = T extends U ? T extends V ? T : never : never;
function f20<T>(x: Extract<Extract<T, Foo>, Bar>, y: Extract<T, Foo & Bar>, z: Extract2<T, Foo, Bar>): void;
function f21<T>(x: Extract<Extract<T, Foo>, Bar>, y: Extract<T, Foo & Bar>, z: Extract2<T, Foo, Bar>): void;
class Opt<T> {
    toVector(): Vector<T>;
}
interface Seq<T> {
...
function toString1(value: object | Function): string;
function toString2(value: Function): string;
...
type IRecordResponse<T extends IRecord> = IResponse<T> & {
    sendRecord(): void;
};
type IResponse<T> = {
    sendValue(name: keyof GetAllPropertiesOfType<T, string>): void;
