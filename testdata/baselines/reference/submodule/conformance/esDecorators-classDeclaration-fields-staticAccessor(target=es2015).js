...
let D = (() => {
    var _a, _D_field1_accessor_storage;
    let _classDecorators = [dec];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var D = (_a = class {
            static get field1() { return __classPrivateFieldGet(_a, _a, "f", _D_field1_accessor_storage); }
            static set field1(value) { __classPrivateFieldSet(_a, _a, value, "f", _D_field1_accessor_storage); }
        },
        _classThis = _a,
