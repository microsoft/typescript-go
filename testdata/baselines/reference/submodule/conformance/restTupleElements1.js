...
type T15 = [boolean, number, ...string[]];
type L15 = T15["length"];
function assign<T, S extends T>(): void;
type T20 = [number, string, ...boolean[]];
type T21 = T20[0];
type T22 = T20[0 | 1];
type T23 = T20[0 | 1 | 2];
...
function f0<T, U>(x: [T, ...U[]]): [T, U];
function f1(a: [(x: number) => number, ...((x: string) => number)[]]): void;
function f2(...a: [(x: number) => number, ...((x: string) => number)[]]): void;
