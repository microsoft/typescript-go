...
const stringOrBoolean: "boolean" | "string";
const booleanOrNumber: "boolean" | "number";
const stringOrBooleanOrNumber: "boolean" | "number" | "string";
namespace Consts2 {
}
...
stringLiteralTypesOverloads01.d.ts(2,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== stringLiteralTypesOverloads01.d.ts (1 errors) ====
    type PrimitiveName = 'string' | 'number' | 'boolean';
    function getFalsyPrimitive(x: "string"): string;
    ~~~~~~~~
