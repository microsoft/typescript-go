...
let f1: (...x: [number, string, boolean]) => void;
let f2: (x0: number, x1: string, x2: boolean) => void;
const t3: [number, string, boolean];
const t2: [string, boolean];
const t1: [boolean];
const t0: [];
const ns: [number, string];
const sn: [string, number];
function f10<T extends unknown[]>(...args: T): T;
const x10: [number, string, boolean];
const x11: [number, string];
const x12: [number];
const x13: [];
const x14: [number, string, boolean];
const x15: [number, string, boolean];
const x16: [number, string, boolean];
const x17: [number, string, boolean];
const x18: [number, string, boolean];
function g10<U extends string[], V extends [number, number]>(u: U, v: V): void;
function f11<T extends (string | number | boolean)[]>(...args: T): T;
const z10: [42, "hello", true];
const z11: [42, "hello"];
const z12: [42];
const z13: [];
const z14: [number, string, boolean];
const z15: [42, string, boolean];
const z16: [42, "hello", boolean];
const z17: [42, "hello", true];
const z18: [number, string, true];
function g11<U extends string[], V extends [number, number]>(u: U, v: V): void;
function call<T extends unknown[], U>(f: (...args: T) => U, ...args: T): U;
function callr<T extends unknown[], U>(args: T, f: (...args: T) => U): U;
function f15(a: string, b: number): string | number;
function f16<A, B>(a: A, b: B): A | B;
let x20: number;
let x21: string;
let x22: string | number;
let x23: string | number;
let x24: string | number;
let x30: string;
let x31: string | number;
let x32: string | number;
function bind<T, U extends unknown[], V>(f: (x: T, ...rest: U) => V, x: T): (...rest: U) => V;
const f20: (x: number, y: string, z: boolean) => string[];
const f21: (y: string, z: boolean) => string[];
const f22: (z: boolean) => string[];
const f23: () => string[];
const g20: (x: number, y?: string, z?: boolean) => string[];
const g21: (y?: string | undefined, z?: boolean | undefined) => string[];
const g22: (z?: boolean | undefined) => string[];
const g23: () => string[];
function f30<T, U extends ((x: T) => any)[]>(x: T, ...args: U): U;
const c30: [(x: number) => string, (x: number) => number];
type T01 = Parameters<(x: number, y: string, z: boolean) => void>;
type T02 = Parameters<(...args: [number, string, boolean]) => void>;
type T03 = ConstructorParameters<new (x: number, y: string, z: boolean) => void>;
type T04 = ConstructorParameters<new (...args: [number, string, boolean]) => void>;
...
var events: EventType<Record1>;
var ff1: (...args: any[]) => void;
var ff2: () => void;
var ff3: (...args: []) => void;
var ff4: (a: never) => void;
