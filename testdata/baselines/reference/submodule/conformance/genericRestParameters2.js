...
const t1: [number, string, ...boolean[]];
const t2: [string, ...boolean[]];
const t3: [...boolean[]];
const t4: [];
let f00: (...x: [number, string, boolean]) => void;
let f01: (a: number, ...x: [string, boolean]) => void;
let f02: (a: number, b: string, ...x: [boolean]) => void;
let f03: (a: number, b: string, c: boolean) => void;
let f04: (a: number, b: string, c: boolean, ...x: []) => void;
let f10: (...x: [number, string, ...boolean[]]) => void;
let f11: (a: number, ...x: [string, ...boolean[]]) => void;
let f12: (a: number, b: string, ...x: [...boolean[]]) => void;
let f13: (a: number, b: string, ...c: boolean[]) => void;
const ns: [number, string];
const sn: [string, number];
const f20: <T extends unknown[]>(...args: T) => T;
type T01 = Parameters<(x: number, y: string, ...z: boolean[]) => void>;
type T02 = Parameters<(...args: [number, string, ...boolean[]]) => void>;
type T03 = ConstructorParameters<new (x: number, y: string, ...z: boolean[]) => void>;
type T04 = ConstructorParameters<new (...args: [number, string, ...boolean[]]) => void>;
...
genericRestParameters2.d.ts(1,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== genericRestParameters2.d.ts (1 errors) ====
    const t1: [number, string, ...boolean[]];
    ~~~~~
