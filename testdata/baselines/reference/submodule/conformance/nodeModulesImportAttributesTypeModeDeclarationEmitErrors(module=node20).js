...
export const a: import("pkg", { with: { "resolution-mode": "foobar" } }).RequireInterface;
export const b: import("pkg", { with: { "resolution-mode": "import" } }).ImportInterface;
//// [other.d.ts]
...
export const a: import("pkg", { with: { "bad": "require" } }).RequireInterface;
export const b: import("pkg", { with: { "bad": "import" } }).ImportInterface;
//// [other3.d.ts]
export type LocalInterface = import("pkg", { with: {} })[{
...
//// [other4.d.ts]
export type LocalInterface = import("pkg", { with: {} });
export const a: import("pkg", { with: {} }), Attribute1: any, RequireInterface: any;
export const b: import("pkg", { with: {} }), Attribute2: any, ImportInterface: any;
//// [other5.d.ts]
export type LocalInterface = import("pkg", { with: {} }).RequireInterface & import("pkg", { with: {} }).ImportInterface;
export const a: import("pkg", { with: {} }).RequireInterface;
export const b: import("pkg", { with: {} }).ImportInterface;
