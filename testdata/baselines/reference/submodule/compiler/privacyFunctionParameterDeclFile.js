...
function publicFunctionWithPublicParmeterTypesInGlobal(param: publicClassInGlobal): void;
function publicAmbientFunctionWithPublicParmeterTypesInGlobal(param: publicClassInGlobal): void;
namespace publicModuleInGlobal {
    class privateClass {
    }
    export class publicClass {
...
privacyFunctionParameterDeclFile_GlobalFile.d.ts(1,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.
privacyFunctionParameterDeclFile_externalModule.d.ts(1,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== privacyFunctionParameterDeclFile_externalModule.d.ts (1 errors) ====
    class privateClass {
    ~~~~~
...
==== privacyFunctionParameterDeclFile_GlobalFile.d.ts (1 errors) ====
    class publicClassInGlobal {
    ~~~~~
!!! error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.
    }
