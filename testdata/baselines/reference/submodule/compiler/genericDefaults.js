...
const x: any;
function f00(a?: A): A;
function f01<T>(a?: T): T;
function f02<T = A>(a?: T): T;
function f03<T = T>(a?: T): T;
function f04<T, U = B>(a?: T, b?: U): [T, U];
function f05<T, U = T>(a?: T, b?: U): [T, U];
function f06<T = A, U = T>(a?: T, b?: U): [T, U];
function f07<T, U = B, V = U>(a?: T, b?: U, c?: V): [T, U, V];
function f08<T extends A, U = T>(a?: T, b?: U): [T, U];
function f09<T, U extends T = T>(a?: T, b?: U): [T, U];
function f10<T extends A, U extends T = T>(a?: T, b?: U): [T, U];
function f11<T, U = T | B>(a?: T, b?: U): [T, U];
function f12<T, U = T & B>(a?: T, b?: U): [T, U];
function f13<T = U, U = B>(a?: T, b?: U): [T, U];
function f14<T, U = V, V = C>(a?: T, b?: U, c?: V): [T, U, V];
function f15<T = U, U = T>(a?: T, b?: U): [T, U];
function f16<T, U = V, V = U>(a?: T, b?: U, c?: V): [T, U, V];
function f17<T = U, U = T | B>(a?: T, b?: U): [T, U];
function f18<T, U = V, V = U | C>(a?: T, b?: U, c?: V): [T, U, V];
function f19<T = U, U = T & B>(a?: T, b?: U): [T, U];
function f20<T, U = V, V = U & C>(a?: T, b?: U, c?: V): [T, U, V];
...
const i01c00: [number, number];
const i01c01: [number, string];
interface i02<T extends number, U = T> {
    a: [T, U];
}
const i02c00: [number, number];
const i02c01: [1, 1];
const i02c02: [number, number];
const i02c03: [1, number];
const i02c04: [number, 1];
interface i03<T extends number, U extends T = T> {
    a: [T, U];
}
const i03c00: [number, number];
const i03c01: [1, 1];
const i03c02: [number, number];
const i03c03: [1, 1];
const i03c04: [number, 1];
interface i04 {
}
interface i04<T> {
}
...
const i06c00: [any, any];
const i06c01: [number, number];
const i06c02: [number, string];
interface i07 {
    a: A;
}
...
const Base01: Base01Constructor;
const Base01c00: Base01<number>;
const Base01c01: Base01<number>;
const Base01c02: Base01<number>;
const Base01c03: Base01<number>;
class Derived01<T> extends Base01<T> {
}
const Derived01c00: Derived01<unknown>;
const Derived01c01: Derived01<number>;
const Derived01c02: Derived01<number>;
const Derived01c03: Derived01<number>;
class Derived02<T = string> extends Base01<T> {
}
const Derived02c00: Derived02<string>;
const Derived02c01: Derived02<number>;
const Derived02c02: Derived02<number>;
const Derived02c03: Derived02<number>;
interface Base02 {
}
interface Base02Constructor {
    new <T = A>(a: T): Base02 & T;
}
const Base02: Base02Constructor;
class Derived03 extends Base02 {
}
const Derived03c00: Derived03;
const Derived03c01: number;
type DerivedProps = keyof Derived03;
type t00<T = number> = {
    a: T;
};
...
const t01c00: [number, number];
const t01c01: [number, string];
type t02<T extends number, U = T> = {
    a: [T, U];
};
const t02c00: [number, number];
const t02c01: [1, 1];
const t02c02: [number, number];
const t02c03: [1, number];
const t02c04: [number, 1];
type t03<T extends number, U extends T = T> = {
    a: [T, U];
};
const t03c00: [number, number];
const t03c01: [1, 1];
const t03c02: [number, number];
const t03c03: [1, 1];
const t03c04: [number, 1];
interface SelfReference<T = SelfReference<string>> {
}
