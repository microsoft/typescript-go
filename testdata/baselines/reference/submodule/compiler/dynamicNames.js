...
export const c0 = "a";
export const c1 = 1;
export const s0: unique symbol;
export interface T0 {
    [c0]: number;
    [c1]: string;
    [s0]: boolean;
}
export class T1 implements T2 {
    [c0]: number;
    [c1]: string;
    [s0]: boolean;
}
...
export const c4 = "a";
export const c5 = 1;
export const s2: typeof s0;
export const o1: {
    a: number;
    1: string;
    [s0]: boolean;
};
export const o1_c4: number;
export const o1_c5: string;
export const o1_s2: boolean;
export const o2: T0;
