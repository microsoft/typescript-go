...
function flatMap(array: T[][]): T[];


//// [DtsFileErrors]


dist/jsFileFunctionOverloads2.d.ts(1,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.
dist/jsFileFunctionOverloads2.d.ts(11,25): error TS2304: Cannot find name 'T'.
dist/jsFileFunctionOverloads2.d.ts(11,33): error TS2304: Cannot find name 'T'.


==== dist/jsFileFunctionOverloads2.d.ts (3 errors) ====
    function getTypeName(x: number): 'number';
    ~~~~~~~~
