...
export const fnExpressionConstVariable: () => number;
export const fnArrowConstVariable: () => string;
export let fnExpressionLetVariable: () => number;
export let fnArrowLetVariable: () => string;
export var fnExpressionVarVariable: () => number;
export var fnArrowVarVariable: () => string;
export const fnExpressionConstVariableOk: () => number;
export const fnArrowConstVariableOk: (cb?: () => void) => string;
export let fnExpressionLetVariableOk: () => number;
export let fnArrowLetVariableOk: (cb?: () => void) => string;
export var fnExpressionVarVariableOk: () => number;
export var fnArrowVarVariableOk: (cb?: () => void) => string;
export class ExportedClass {
    #private;
    fnExpression: () => number;
    fnArrow: () => string;
...
export const instance: IndirectlyExportedClass;
export const fnParamExpressionConstVariable: (cb?: () => void) => number;
export const fnParamArrowConstVariable: (cb?: () => number) => string;
export let fnParamExpressionLetVariable: (cb?: () => void) => number;
export let fnParamArrowLetVariable: (cb?: () => number) => string;
export var fnParamExpressionVarVariable: (cb?: () => void) => number;
export var fnParamArrowVarVariable: (cb?: () => number) => string;
export const fnParamExpressionConstVariableOwnerHasReturnType: (cb?: () => void) => number;
export const fnParamArrowConstVariableOwnerHasReturnType: (cb?: () => void) => string;
export let fnParamExpressionLetVariableOwnerHasReturnType: (cb?: () => void) => number;
export let fnParamArrowLetVariableOwnerHasReturnType: (cb?: () => void) => string;
export var fnParamExpressionVarVariableOwnerHasReturnType: (cb?: () => void) => number;
export var fnParamArrowVarVariableOwnerHasReturnType: (cb?: () => void) => string;
export const fnParamExpressionConstVariableOk: (cb?: () => void) => number;
export const fnParamArrowConstVariableOk: (cb?: () => void) => string;
export let fnParamExpressionLetVariableOk: (cb?: () => void) => number;
export let fnParamArrowLetVariableOk: (cb?: () => void) => string;
export var fnParamExpressionVarVariableOk: (cb?: () => void) => number;
export var fnParamArrowVarVariableOk: (cb?: () => void) => string;
export const fnParamExpressionConstVariableInternal: (cb?: () => void) => number;
export const fnParamArrowConstVariableInternal: (cb?: () => number) => string;
export let fnParamExpressionLetVariableInternal: (cb?: () => void) => number;
export let fnParamArrowLetVariableInternal: (cb?: () => number) => string;
export var fnParamExpressionVarVariableInternal: (cb?: () => void) => number;
export var fnParamArrowVarVariableInternal: (cb?: () => number) => string;
export class FnParamsExportedClass {
    #private;
