...
commentsInterface.d.ts(4,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== commentsInterface.d.ts (1 errors) ====
    /** this is interface 1*/
    interface i1 {
    }
    var i1_i: i1;
