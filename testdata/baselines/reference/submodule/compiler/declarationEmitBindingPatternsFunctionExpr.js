...
let value: string;
const shadowedVariable: ({ value: alias }: {
    value: string;
}) => typeof value;
...
declarationEmitBindingPatternsFunctionExpr.d.ts(4,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== declarationEmitBindingPatternsFunctionExpr.d.ts (1 errors) ====
    type Named = {
        name: string;
    };
    let notReferenced: ({ name: alias }: Named) => void;
