...
namespace templa.mvc.composite {
    interface ICompositeControllerModel extends mvc.IModel {
        getControllers(): mvc.IController<mvc.IModel>[];
    }
}
...
declFileGenericType2.d.ts(1,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== declFileGenericType2.d.ts (1 errors) ====
    namespace templa.mvc {
    ~~~~~~~~~
