...
function duplicateIndetifiers({ name: alias, name: alias2 }: Named): void;
function duplicateIndetifiers2(name: string, { name: alias }: Named): void;
function duplicateIndetifiers3({ name: alias }: Named, { name: alias2 }: Named): void;
let value: string;
function shadowedVariable({ value: alias }: {
    value: string;
}): typeof value;
function notReferenced({ name: alias }: Named): void;
function notReferencedNestedAlias({ p: { name: alias } }: {
    p: Named;
}): void;
function notReferencedArrayAlias([a, b, { name: alias }]: Named[]): void;
function referencedInCode({ name: alias }: Named): string;
function referencedInSignarture({ name: alias }: Named): typeof alias;
function referencedInSignartureKeyword({ function: alias }: {
    function: string;
}): typeof alias;
...
function referencedInNestedFunction({ name: alias }: Named): (p: typeof alias) => void;
function referencedNestedAlias({ p: { name: alias } }: {
    p: Named;
}): typeof alias;
function referencedArrayAlias([a, b, { name: alias }]: Named[]): typeof alias;
