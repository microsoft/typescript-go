...
const x: any;
function f03<T extends string = number>(): void;
function f04<T extends string, U extends number = T>(): void;
function f05<T, U extends number = T>(): void;
function f06<T, U extends T = number>(): void;
function f11<T, U, V = number>(): void;
function f12<T, U = T>(a?: U): void;
interface i00<T> {
}
