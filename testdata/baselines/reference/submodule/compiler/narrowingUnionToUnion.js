...
function fx1(x: string | number | undefined): void;
function fx2<T>(x: T | undefined): void;
function fx3<T extends string | number>(x: T): void;
function isA(obj: unknown): obj is {
    a: false;
} | {
    b: 0;
};
...
function isXSorY(obj: unknown): obj is XS | Y;
function fx5<T extends X>(obj: X | YS, c: typeof XS | typeof Y): void;
function isEmptyStrOrUndefined(mixed: any): mixed is "" | undefined;
function fx10(s: string | undefined): void;
function f1(x: any): asserts x is number | undefined;
let v1: number | string | undefined;
function f2(x: any): asserts x is 6 | undefined;
let v2: number | string | undefined;
function isEmptyString(value: string): value is '';
function isMaybeEmptyString(value: string | null | undefined): value is '' | null | undefined;
function isZero(value: number): value is 0;
function isMaybeZero(value: number | null | undefined): value is 0 | null | undefined;
function isEmptyArray<T>(value: T[]): value is [];
function isMaybeEmptyArray<T>(value: T[] | null | undefined): value is [] | null | undefined;
const TEST_CASES: (((value: string) => void) | ((value: number) => void) | ((value: string[]) => void))[];
type EmptyString = '' | null | undefined;
function isEmpty(value: string | EmptyString): value is EmptyString;
let test: string | null | undefined;
function assert<T>(value: any): asserts value is T;
function test1(foo: number | string | boolean): void;
function check1(x: unknown): x is (string | 0);
function check2(x: unknown): x is ("hello" | 0);
function test3(x: unknown): void;
function assertRelationIsNullOrStringArray(v: (string | number)[] | null): asserts v is string[] | null;
function f1x(obj: (string | number)[] | null): void;
...
function isMyDiscriminatedUnion(item: unknown): item is MyDiscriminatedUnion;
const working: unknown;
const broken: Record<string, any> | undefined;
const workingAgain: Record<string, any> | undefined | unknown;
type Union = {
    type: 'a';
    variant: 1;
} | {
...
function example1(value: Union): {
    type: 'a';
    variant: 2;
} | null;
function example2(value: Union): {
    type: 'a';
    variant: 2;
} | null;
function example3(value: Union): {
    type: 'a';
    variant: 2;
} | null;
...
narrowingUnionToUnion.d.ts(2,1): error TS1046: Top-level declarations in .d.ts files must start with either a 'declare' or 'export' modifier.


==== narrowingUnionToUnion.d.ts (1 errors) ====
    type Falsy = false | 0 | 0n | '' | null | undefined;
    function isFalsy(value: unknown): value is Falsy;
    ~~~~~~~~
