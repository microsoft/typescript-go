...
export var a: C.A<C.B>;
export var b: typeof C.F;
export var c: typeof C.F2;
export var d: typeof C.F3;
export var e: typeof C.F4;
export var x: C.A<C.B>;
export function f<T extends C.A<C.B>>(): void;
export var g: C.A<C.B>;
export class h extends C.A<C.B> {
}
export interface i extends C.A<C.B> {
}
export var j: typeof C.F6;
