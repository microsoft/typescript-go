...
{"version":"FakeTSVersion","root":[2],"fileNames":["lib.es2025.full.d.ts","./src/c.ts"],"fileInfos":[{"version":"8859c12c614ce56ba9a18e58384a198f-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},{"version":"0c1eb6b93bf327534ca72bc76ad6f9dc-export const cc = 10;","signature":"94758c4359c6bebb777c6a6693f545ab-export const cc = 10;\n","impliedNodeFormat":1}],"options":{"composite":true},"latestChangedDtsFile":"./src/c.d.ts"}
//// [/home/src/workspaces/solution/project3/tsconfig.tsbuildinfo.readable.baseline.txt] *modified* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "94758c4359c6bebb777c6a6693f545ab-export const cc = 10;\n",
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "0c1eb6b93bf327534ca72bc76ad6f9dc-export const cc = 10;",
        "signature": "94758c4359c6bebb777c6a6693f545ab-export const cc = 10;\n",
