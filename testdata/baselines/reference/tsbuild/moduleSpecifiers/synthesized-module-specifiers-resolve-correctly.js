...
//// [/home/src/workspaces/packages/lib/solution/sub-project-2/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "version": "5a6be79cf4b8a286e4270d0b3113f958-export type Nominal<T, Name extends string> = T & {};\n",
      "signature": "5a6be79cf4b8a286e4270d0b3113f958-export type Nominal<T, Name extends string> = T & {};\n",
      "impliedNodeFormat": "CommonJS"
    },
    {
