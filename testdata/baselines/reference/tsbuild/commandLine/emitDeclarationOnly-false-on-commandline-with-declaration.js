...
{"version":"FakeTSVersion","root":["./e.ts","./f.ts","./g.ts"]}
...
[[90mHH:MM:SS AM[0m] Project 'project2/src/tsconfig.json' is up to date because newest input 'project2/src/e.ts' is older than output 'project2/src/e.d.ts'
...
[[90mHH:MM:SS AM[0m] Project 'project2/src/tsconfig.json' is out of date because output 'project2/src/e.d.ts' is older than input 'project1/src'
...
[[90mHH:MM:SS AM[0m] Project 'project2/src/tsconfig.json' is out of date because output file 'project2/src/e.js' does not exist
...
[[90mHH:MM:SS AM[0m] Project 'project2/src/tsconfig.json' is up to date because newest input 'project2/src/e.ts' is older than output 'project2/src/g.d.ts'
...
[[90mHH:MM:SS AM[0m] Project 'project2/src/tsconfig.json' is up to date because newest input 'project2/src/e.ts' is older than output 'project2/src/g.js'
...
[[90mHH:MM:SS AM[0m] Project 'project2/src/tsconfig.json' is out of date because output 'project2/src/g.js' is older than input 'project1/src'
