...
{"version":"FakeTSVersion","root":[[2,4]],"packageJsons":["../package.json"],"fileNames":["lib.es2025.full.d.ts","../src/util.native.ts","../index.native.ts","../src/util.ts"],"fileInfos":[{"version":"8859c12c614ce56ba9a18e58384a198f-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},"c1f8db351239c175fbb3960262e28684-export const platform = \"native\" as const;","0a747b719fd37e7b799139c5f607d76b-export { platform } from \"./src/util\";","7941de8fb997b556c0afef2b586d7205-export const platform = \"web\" as const;"],"fileIdsList":[[2]],"options":{"composite":true,"emitDeclarationOnly":true,"declaration":true,"module":99,"outDir":"./","strict":true},"referencedMap":[[3,1]],"latestChangedDtsFile":"./src/util.d.ts","emitSignatures":[[2,"1f876b2eee633f65aa2e7817bfee737a-export declare const platform: \"native\";\n"],[3,"b065ccf77d7f1159c74552524b8d4d2b-export { platform } from \"./src/util\";\n"],[4,"5082e4a38cc5cc308625a8754198c0e3-export declare const platform: \"web\";\n"]]}
//// [/home/src/workspaces/project/pkg/dist/tsconfig.native.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "c1f8db351239c175fbb3960262e28684-export const platform = \"native\" as const;",
      "impliedNodeFormat": "CommonJS"
    },
    {
      "fileName": "../index.native.ts",
      "version": "0a747b719fd37e7b799139c5f607d76b-export { platform } from \"./src/util\";",
      "signature": "0a747b719fd37e7b799139c5f607d76b-export { platform } from \"./src/util\";",
      "impliedNodeFormat": "CommonJS"
    },
    {
      "fileName": "../src/util.ts",
      "version": "7941de8fb997b556c0afef2b586d7205-export const platform = \"web\" as const;",
      "signature": "7941de8fb997b556c0afef2b586d7205-export const platform = \"web\" as const;",
      "impliedNodeFormat": "CommonJS"
    }
  ],
  "fileIdsList": [
  ...
  "emitSignatures": [
    {
      "file": "../src/util.native.ts",
      "signature": "1f876b2eee633f65aa2e7817bfee737a-export declare const platform: \"native\";\n",
      "original": [
        2,
        "1f876b2eee633f65aa2e7817bfee737a-export declare const platform: \"native\";\n"
      ]
    },
    {
