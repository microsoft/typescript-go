...
{"version":"FakeTSVersion","root":[[2,3]],"fileNames":["../../../../tslibs/TS/Lib/lib.d.ts","../../shared/index.ts","../../shared/typings-base/globals.d.ts"],"fileInfos":[{"version":"eae9e83ef0f77eeb2e35dc9b91facce1-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},{"version":"8554f24167d6acddca6193f36522b428-export const a: Unrestricted = 1;","signature":"0125bd398fe8c57a1edda4bb7c8ab568-export declare const a: Unrestricted;\n","impliedNodeFormat":1},{"version":"5ea9d79651f4d433da86e4bc557d9591-type Unrestricted = any;","affectsGlobalScope":true,"impliedNodeFormat":1}],"options":{"composite":true,"outDir":"..","rootDir":"../.."},"latestChangedDtsFile":"./index.d.ts"}
//// [/home/src/workspaces/solution/target-tsc-build/shared/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "version": "8554f24167d6acddca6193f36522b428-export const a: Unrestricted = 1;",
      "signature": "0125bd398fe8c57a1edda4bb7c8ab568-export declare const a: Unrestricted;\n",
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "8554f24167d6acddca6193f36522b428-export const a: Unrestricted = 1;",
        "signature": "0125bd398fe8c57a1edda4bb7c8ab568-export declare const a: Unrestricted;\n",
    ...
    },
    {
      ...
      "version": "5ea9d79651f4d433da86e4bc557d9591-type Unrestricted = any;",
      "signature": "5ea9d79651f4d433da86e4bc557d9591-type Unrestricted = any;",
      "affectsGlobalScope": true,
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "5ea9d79651f4d433da86e4bc557d9591-type Unrestricted = any;",
...
{"version":"FakeTSVersion","root":[[2,3]],"fileNames":["../../../../tslibs/TS/Lib/lib.d.ts","../../webpack/index.ts","../../shared/typings-base/globals.d.ts"],"fileInfos":[{"version":"eae9e83ef0f77eeb2e35dc9b91facce1-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},{"version":"5ec8fefa6fbd869610df112c27d83ba3-export const b: Unrestricted = 1;","signature":"7e69eb7f90004ec22d25c232f6284ef1-export declare const b: Unrestricted;\n","impliedNodeFormat":1},{"version":"5ea9d79651f4d433da86e4bc557d9591-type Unrestricted = any;","affectsGlobalScope":true,"impliedNodeFormat":1}],"options":{"composite":true,"outDir":"..","rootDir":"../.."},"latestChangedDtsFile":"./index.d.ts"}
//// [/home/src/workspaces/solution/target-tsc-build/webpack/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "version": "5ec8fefa6fbd869610df112c27d83ba3-export const b: Unrestricted = 1;",
      "signature": "7e69eb7f90004ec22d25c232f6284ef1-export declare const b: Unrestricted;\n",
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "5ec8fefa6fbd869610df112c27d83ba3-export const b: Unrestricted = 1;",
        "signature": "7e69eb7f90004ec22d25c232f6284ef1-export declare const b: Unrestricted;\n",
