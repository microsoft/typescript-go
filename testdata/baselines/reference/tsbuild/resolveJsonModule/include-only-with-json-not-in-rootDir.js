...
{"version":"FakeTSVersion","root":[3],"fileNames":["lib.es2025.full.d.ts","./hello.json","./src/index.ts"],"fileInfos":[{"version":"8859c12c614ce56ba9a18e58384a198f-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},{"version":"18e7247c85a6a2e7a4ec2e284716edd8-{\n    \"hello\": \"world\"\n}"},"a4ada5a36528c3fb01d6f98af94bc507-import hello from \"../hello.json\"\nexport default hello.hello"],"fileIdsList":[[2]],"options":{"composite":true,"module":1,"outDir":"./dist","rootDir":"./src","skipDefaultLibCheck":true,"allowSyntheticDefaultImports":true,"esModuleInterop":true},"referencedMap":[[3,1]],"latestChangedDtsFile":"./dist/index.d.ts","emitSignatures":[[3,"a44184f4ac1ed50126ac624c885b51a8-declare const _default: string;\nexport default _default;\n"]]}
//// [/home/src/workspaces/solution/project/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "a4ada5a36528c3fb01d6f98af94bc507-import hello from \"../hello.json\"\nexport default hello.hello",
      "impliedNodeFormat": "CommonJS"
    }
  ],
  "fileIdsList": [
