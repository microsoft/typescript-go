...
//// [/home/src/workspaces/lib/common/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "2a480df008713dde67e457ba9dde58cb-export type Nominal<T, Name> = T & {};\n/**\n * @template T, Name\n * @typedef {T & {[Symbol.species]: Name}} Nominal\n */\nconst _default: {};\nexport = _default;\n",
      "impliedNodeFormat": "CommonJS",
      "original": {
        "version": "a19075dfba5b2d593b761ed8d8cd526f-/**\n * @template T, Name\n * @typedef {T & {[Symbol.species]: Name}} Nominal\n */\nmodule.exports = {};",
        "signature": "2a480df008713dde67e457ba9dde58cb-export type Nominal<T, Name> = T & {};\n/**\n * @template T, Name\n * @typedef {T & {[Symbol.species]: Name}} Nominal\n */\nconst _default: {};\nexport = _default;\n",
...
//// [/home/src/workspaces/lib/sub-project-2/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "version": "2a480df008713dde67e457ba9dde58cb-export type Nominal<T, Name> = T & {};\n/**\n * @template T, Name\n * @typedef {T & {[Symbol.species]: Name}} Nominal\n */\nconst _default: {};\nexport = _default;\n",
      "signature": "2a480df008713dde67e457ba9dde58cb-export type Nominal<T, Name> = T & {};\n/**\n * @template T, Name\n * @typedef {T & {[Symbol.species]: Name}} Nominal\n */\nconst _default: {};\nexport = _default;\n",
      "impliedNodeFormat": "CommonJS"
    },
    {
