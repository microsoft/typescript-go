...
//// [/user/username/projects/demo/lib/animals/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "version": "e4a3aa3e1bee64a18afa6dd272642427-export function makeRandomName(): string;\nexport function lastElementOf<T>(arr: T[]): T | undefined;\n",
      "signature": "e4a3aa3e1bee64a18afa6dd272642427-export function makeRandomName(): string;\nexport function lastElementOf<T>(arr: T[]): T | undefined;\n",
      "impliedNodeFormat": "CommonJS"
    },
    {
...
//// [/user/username/projects/demo/lib/zoo/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "version": "e6b2ab4639c1dfc3cab3639b533d0860-import Animal from '.';\nexport interface Dog extends Animal {\n    woof(): void;\n    name: string;\n}\nexport function createDog(): Dog;\n",
      "signature": "e6b2ab4639c1dfc3cab3639b533d0860-import Animal from '.';\nexport interface Dog extends Animal {\n    woof(): void;\n    name: string;\n}\nexport function createDog(): Dog;\n",
      "impliedNodeFormat": "CommonJS"
    },
    {
