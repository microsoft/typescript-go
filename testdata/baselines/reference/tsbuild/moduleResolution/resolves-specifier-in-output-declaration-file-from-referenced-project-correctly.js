...
{"version":"FakeTSVersion","root":[[2,3]],"packageJsons":["../package.json"],"fileNames":["lib.es2025.full.d.ts","../const.ts","../index.ts"],"fileInfos":[{"version":"8859c12c614ce56ba9a18e58384a198f-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},"be0f939ab1143e4064a3742586332724-export type TheNum = 42;","0b8e978a1e274cdc446fbbcbc9e78724-export type { TheNum } from 'const';"],"fileIdsList":[[2]],"options":{"composite":true,"outDir":"./"},"referencedMap":[[3,1]],"latestChangedDtsFile":"./index.d.ts","emitSignatures":[[2,"56e2d69d2edd1f0edd1a64ecfdf6de0d-export type TheNum = 42;\n"],[3,"1a74e021c93cb748502ffc92156e3427-export type { TheNum } from 'const';\n"]]}
//// [/user/username/projects/myproject/packages/pkg2/build/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "0b8e978a1e274cdc446fbbcbc9e78724-export type { TheNum } from 'const';",
      "impliedNodeFormat": "CommonJS"
    }
  ],
  "fileIdsList": [
  ...
  "emitSignatures": [
    ...
    },
    {
      ...
      "original": [
        3,
        "1a74e021c93cb748502ffc92156e3427-export type { TheNum } from 'const';\n"
      ]
    }
  ],
  "size": 1346
