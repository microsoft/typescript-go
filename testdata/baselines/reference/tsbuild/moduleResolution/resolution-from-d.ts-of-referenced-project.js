...
//// [/home/src/workspaces/project/producer/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "emitSignatures": [
    {
      "file": "./index.ts",
      "signature": "80964026d42fdf94ec2486f22638be7c-846f65cd8d68b44b74d0de4a41b17245-export { ValueProducerDeclaration } from \"./in-js\";\nimport { OnValue } from \"@common\";\nexport interface ValueProducerFromTs {\n    onValue: OnValue;\n}\n\n/home/src/workspaces/project/producer/in-js.d.ts=7677191ddc32f3fe5aa447395ff0553a-import { OnValue } from \"@common\"\nexport interface ValueProducerDeclaration {\n    onValue: OnValue;\n}",
      "original": [
        4,
        "80964026d42fdf94ec2486f22638be7c-846f65cd8d68b44b74d0de4a41b17245-export { ValueProducerDeclaration } from \"./in-js\";\nimport { OnValue } from \"@common\";\nexport interface ValueProducerFromTs {\n    onValue: OnValue;\n}\n\n/home/src/workspaces/project/producer/in-js.d.ts=7677191ddc32f3fe5aa447395ff0553a-import { OnValue } from \"@common\"\nexport interface ValueProducerDeclaration {\n    onValue: OnValue;\n}"
      ]
    }
  ],
  "size": 2154
