...
{"version":"FakeTSVersion","root":[[2,5]],"fileNames":["lib.es2025.full.d.ts","./aworker.ts","./c.ts","./b.ts","./file.ts"],"fileInfos":[{"version":"8859c12c614ce56ba9a18e58384a198f-/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }\ninterface ReadonlyArray<T> {}\ninterface SymbolConstructor {\n    (desc?: string | number): symbol;\n    for(name: string): symbol;\n    readonly toStringTag: symbol;\n}\ndeclare var Symbol: SymbolConstructor;\ninterface Symbol {\n    readonly [Symbol.toStringTag]: string;\n}\ndeclare const console: { log(msg: any): void; };","affectsGlobalScope":true,"impliedNodeFormat":1},"5fe80ccba36a579325309b8069ecdcbf-export const AWorker  = 10","27be335cb83f09e0543d1a6458f51e79-import {A} from \"./b\"\nlet b = A.ONE\nexport {A}","fd5de56c8fb277639e17b90c496b1f4e-import { AWorker } from \"./aworker\"\nimport { A as ACycle } from \"./c\"\nexport const enum A {\n    ONE = 1\n}","f69fa3d8747995fb7603cfd9c694aa6b-import {A} from \"./c\"\nlet a = A.ONE"],"fileIdsList":[[2,3],[4],[3]],"options":{"composite":true},"referencedMap":[[4,1],[3,2],[5,3]],"latestChangedDtsFile":"./file.d.ts","emitSignatures":[[2,"6bac69de224c872c50dea01f4c4b43d6-export declare const AWorker = 10;\n"],[3,"f6d90ac6a94594899853de488fc81940-import { A } from \"./b\";\nexport { A };\n"],[4,"d315610a03cc0f05df42654a56107b7a-export declare const enum A {\n    ONE = 1\n}\n"],[5,"abe7d9981d6018efb6b2b794f40a1607-export {};\n"]]}
//// [/home/src/workspaces/project/tsconfig.tsbuildinfo.readable.baseline.txt] *new* 
{
  ...
  "fileInfos": [
    ...
    },
    {
      ...
      "signature": "5fe80ccba36a579325309b8069ecdcbf-export const AWorker  = 10",
      "impliedNodeFormat": "CommonJS"
    },
    {
      "fileName": "./c.ts",
    ...
    },
    {
      ...
      "signature": "fd5de56c8fb277639e17b90c496b1f4e-import { AWorker } from \"./aworker\"\nimport { A as ACycle } from \"./c\"\nexport const enum A {\n    ONE = 1\n}",
      "impliedNodeFormat": "CommonJS"
    },
    {
      "fileName": "./file.ts",
  ...
  "emitSignatures": [
    {
      ...
      "original": [
        2,
        "6bac69de224c872c50dea01f4c4b43d6-export declare const AWorker = 10;\n"
      ]
    },
    {
      "file": "./c.ts",
      ...
      "original": [
        3,
        "f6d90ac6a94594899853de488fc81940-import { A } from \"./b\";\nexport { A };\n"
      ]
    },
    {
      "file": "./b.ts",
      ...
      "original": [
        4,
        "d315610a03cc0f05df42654a56107b7a-export declare const enum A {\n    ONE = 1\n}\n"
      ]
    },
    {
      "file": "./file.ts",
...
//// [/home/src/workspaces/project/file.js] *rewrite with same content*
