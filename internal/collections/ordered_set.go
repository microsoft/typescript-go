...
func NewOrderedSetWithSizeHint[T comparable](hint int) *OrderedSet[T] /* ref: nonnil */ {
	return &OrderedSet[T]{
...
func (s *OrderedSet[T] /* ref: nonnil */) Values() iter.Seq[T] {
	return s.m.Keys()
}
...
func (s *OrderedSet[T] /* ref: nonnil */) Clone() *OrderedSet[T] /* ref: nonnil */ {
	return &OrderedSet[T]{
		m: s.m.clone(),
	}
}
