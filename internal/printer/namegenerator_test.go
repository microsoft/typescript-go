...
func TestTempVariable1(t *testing.T) {
	...
	ctx := &printer.EmitContext{}
	name1 := ctx.NewTempVariable(printer.AutoGenerateOptions{})
	name2 := ctx.NewTempVariable(printer.AutoGenerateOptions{})

	g := &printer.NameGenerator{Context: ctx}
...
func TestTempVariableScopedReserved(t *testing.T) {
	...
	ctx := &printer.EmitContext{}
	name1 := ctx.NewTempVariable(printer.AutoGenerateOptions{Flags: printer.GeneratedIdentifierFlagsReservedInNestedScopes})
	name2 := ctx.NewTempVariable(printer.AutoGenerateOptions{})
...
func TestLoopVariable1(t *testing.T) {
	...
	ctx := &printer.EmitContext{}
	name1 := ctx.NewLoopVariable(printer.AutoGenerateOptions{})
	name2 := ctx.NewLoopVariable(printer.AutoGenerateOptions{})
...
func TestUniqueName1(t *testing.T) {
	...
	ctx := &printer.EmitContext{}
	name1 := ctx.NewUniqueName("foo", printer.AutoGenerateOptions{})
	name2 := ctx.NewUniqueName("foo", printer.AutoGenerateOptions{})
...
func TestUniquePrivateName1(t *testing.T) {
	...
	ctx := &printer.EmitContext{}
	name1 := ctx.NewUniquePrivateName("#foo", printer.AutoGenerateOptions{})
	name2 := ctx.NewUniquePrivateName("#foo", printer.AutoGenerateOptions{})
...
func TestGeneratedNameForIdentifier1(t *testing.T) {
	...
	name1 := ctx.NewGeneratedNameForNode(n, printer.AutoGenerateOptions{})

	g := &printer.NameGenerator{Context: ctx, GetTextOfNode: (*ast.Node).Text}
	text1 := g.GenerateName(name1)
...
func TestGeneratedNameForIdentifier3(t *testing.T) {
	...
	name2 := ctx.NewGeneratedNameForNode(name1, printer.AutoGenerateOptions{})
...
func TestGeneratedNameForNamespace1(t *testing.T) {
	...
	name1 := ctx.NewGeneratedNameForNode(ns1, printer.AutoGenerateOptions{})
...
func TestGeneratedNameForNamespace3(t *testing.T) {
	...
	name1 := ctx.NewGeneratedNameForNode(ns1, printer.AutoGenerateOptions{})
	name2 := ctx.NewGeneratedNameForNode(ns2, printer.AutoGenerateOptions{})
...
func TestGeneratedNameForNodeCached(t *testing.T) {
	...
	ns1 := file.Statements.Nodes[0]
	name1 := ctx.NewGeneratedNameForNode(ns1, printer.AutoGenerateOptions{})
	name2 := ctx.NewGeneratedNameForNode(ns1, printer.AutoGenerateOptions{})
...
func TestGeneratedPrivateNameForMethod(t *testing.T) {
	...
	n := file.Statements.Nodes[0].AsClassDeclaration().Members.Nodes[0]
	name1 := ctx.NewGeneratedPrivateNameForNode(n, printer.AutoGenerateOptions{})
