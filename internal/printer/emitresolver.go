...
type EmitResolver interface {
	...
	ResolveIndexedAccessTypeNode(emitContext *EmitContext, typeNode *ast.IndexedAccessTypeNode, enclosingDeclaration *ast.Node, flags nodebuilder.Flags, internalFlags nodebuilder.InternalFlags, tracker nodebuilder.SymbolTracker) *ast.Node
