...
func TestEmit(t *testing.T) {
	...
	data := []struct {
		...
		{title: "FunctionExpression#9", input: `(function*(){})`, output: `(function* () { });`},
		{title: "FunctionExpression#10", input: `(async function*(){})`, output: `(async function* () { });`},
		...
		{title: "PropertyAssignment#2", input: `({a:function*(){}})`, output: `({ a: function* () { } });`},
		{title: "PropertyAssignment#3", input: `({a:async function*(){}})`, output: `({ a: async function* () { } });`},
