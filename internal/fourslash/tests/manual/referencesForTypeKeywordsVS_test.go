...
func TestReferencesForTypeKeywordsVS(t *testing.T) {
	t.Parallel()
...
type A5<T> = /*readonlyOperator_readonlyKeyword*/readonly T[];`
	...
	defer done()
	f.VerifyBaselineVsFindAllReferences(t, "typeParam_extendsKeyword", "conditionalType_extendsKeyword", "inferType_inferKeyword", "mappedType_inOperator", "keyofOperator_keyofKeyword", "readonlyOperator_readonlyKeyword")
}
