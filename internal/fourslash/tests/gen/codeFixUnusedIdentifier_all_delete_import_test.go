...
// To modify this test, run "npm run makemanual codeFixUnusedIdentifier_all_delete_import"
...
func TestCodeFixUnusedIdentifier_all_delete_import(t *testing.T) {
...
export type Length<T> = T extends ArrayLike<infer U> ? number : never; // Not affected, can't delete`
	...
	f.VerifyCodeFixAll(t, fourslash.VerifyCodeFixAllOptions{
		...
		NewFileContent: `import { used1 } from "foo";
