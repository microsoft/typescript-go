...
console.log(a, b);`
	...
	defer done()
	f.VerifyOrganizeImports(t, `import { a, type A, b } from "foo";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
		OrganizeImportsTypeOrder: lsutil.OrganizeImportsTypeOrderInline,
	})
	f.ReplaceLine(t, 0, "import { a, type A, b } from \"foo1\";")
	f.VerifyOrganizeImports(t, `import { a, type A, b } from "foo1";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
	...
	f.VerifyOrganizeImports(t, `import { a, type A, b } from "foo2";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
	...
	f.VerifyOrganizeImports(t, `import { type A, a, b } from "foo3";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
