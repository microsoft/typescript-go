...
<foo [|prop_/**/|] />`
	...
	f.VerifyCompletions(t, "", &fourslash.CompletionsExpectedList{
		...
		UserPreferences: &lsutil.UserPreferences{JsxAttributeCompletionStyle: lsutil.JsxAttributeCompletionStyleNone, IncludeCompletionsWithSnippetText: core.TSTrue},
	})
}
