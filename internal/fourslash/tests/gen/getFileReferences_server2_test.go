...
// To modify this test, run "npm run makemanual getFileReferences_server2"
...
func TestGetFileReferences_server2(t *testing.T) {
...
import "@shared/referenced";`
	...
	f.VerifyBaselineFindFileReferences(t, "/home/src/workspaces/project/packages/shared/src/referenced.ts")
}
