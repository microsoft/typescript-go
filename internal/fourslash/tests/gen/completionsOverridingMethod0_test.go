...
// To modify this test, run "npm run makemanual completionsOverridingMethod0"
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:      "foo",
					InsertText: new("foo(param1: string, param2: boolean): Promise<void> {\n}"),
					FilterText: new("foo"),
	...
	f.VerifyCompletions(t, "b", &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:      "foo",
					InsertText: new("foo(a: string, b: string): string {\n}"),
					FilterText: new("foo"),
					SortText:   new(string(ls.SortTextLocationPriority)),
				},
			},
	...
	f.VerifyCompletions(t, "c", &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:      "foo",
					InsertText: new("foo(a: string): string {\n}"),
					FilterText: new("foo"),
					SortText:   new(string(ls.SortTextLocationPriority)),
				},
			},
