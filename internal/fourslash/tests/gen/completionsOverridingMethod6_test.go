...
// To modify this test, run "npm run makemanual completionsOverridingMethod6"
	...
	f.VerifyCompletions(t, "c", &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:               "method",
					InsertText:          new("public override method(): void {\n}"),
					FilterText:          new("method"),
					SortText:            new(string(ls.SortTextLocationPriority)),
					AdditionalTextEdits: fourslash.AnyTextEdits,
					Data: &lsproto.CompletionItemData{
				...
				&lsproto.CompletionItem{
					Label:               "prop",
					InsertText:          new("public override prop: number;"),
					FilterText:          new("prop"),
					SortText:            new(string(ls.SortTextLocationPriority)),
					AdditionalTextEdits: fourslash.AnyTextEdits,
					Data: &lsproto.CompletionItemData{
