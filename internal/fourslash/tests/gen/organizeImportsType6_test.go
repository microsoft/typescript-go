...
console.log(a, b);`
	...
	defer done()
	f.VerifyOrganizeImports(t, `import { type a, A, b } from "foo";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
		OrganizeImportsTypeOrder: lsutil.OrganizeImportsTypeOrderInline,
	})
	f.ReplaceLine(t, 0, "import { type a, A, b } from \"foo1\";")
	f.VerifyOrganizeImports(t, `import { type a, A, b } from "foo1";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
	...
	f.VerifyOrganizeImports(t, `import { type a, A, b } from "foo2";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
	...
	f.VerifyOrganizeImports(t, `import { A, type a, b } from "foo3";
interface Use extends A {}
console.log(a, b);`, nil, &lsutil.UserPreferences{
