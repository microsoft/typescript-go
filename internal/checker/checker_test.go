...
foo.bar;`
	...
	cd := "/"
	host := compiler.NewCompilerHost(cd, fs, bundled.LibPath(), nil /*extendedConfigCache*/)
...
func TestCheckSrcCompiler(t *testing.T) {
	...
	host := compiler.NewCompilerHost(rootPath, fs, bundled.LibPath(), nil /*extendedConfigCache*/)
