...
const (
	...
	TypeFlagsUnion           TypeFlags = 1 << 21 // Union (T | U)
	TypeFlagsIntersection    TypeFlags = 1 << 22 // Intersection (T & U)
	TypeFlagsIndex           TypeFlags = 1 << 23 // keyof T
	TypeFlagsIndexedAccess   TypeFlags = 1 << 24 // T[K]
	TypeFlagsConditional     TypeFlags = 1 << 25 // T extends U ? X : Y
	TypeFlagsSubstitution    TypeFlags = 1 << 26 // Type parameter substitution
