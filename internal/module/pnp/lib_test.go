...
func TestResolveToUnqualifiedExample(t *testing.T) {
	t.Parallel()
	m, err := LoadPNPManifest("/testdata/pnp-yarn-v3.cjs")
	if err != nil {
...
func TestLoadPnPManifest(t *testing.T) {
	...
	cases := []struct {
		...
		{"./testdata/pnp-yarn-v3.cjs", "Expected to load the .pnp.cjs file generated by Yarn 3"},
		{"./testdata/pnp-yarn-v4.cjs", "Expected to load the .pnp.cjs file generated by Yarn 4"},
	}
...
func TestResolveUnqualified(t *testing.T) {
	...
	expectationsPath := filepath.Join(cwd, "/testdata", "test-expectations.json")
...
func TestEdgeCase_OnePkgCachedAndUnplugged(t *testing.T) {
	...
	manifestJSONPath := filepath.Join(cwd, "/testdata", "edge_case_manifest_state.json")
