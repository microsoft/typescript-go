...
type parseTask struct {
	...
	importHelpersImportSpecifier *importHelpersImportSpecifier
...
func (w *filesParser) getProcessedFiles(loader *fileLoader) processedFiles {
	...
	var importHelpersImportSpecifiers map[tspath.Path]*importHelpersImportSpecifier
		...
		for _, task := range tasks {
			...
			if task.importHelpersImportSpecifier != nil {
				if importHelpersImportSpecifiers == nil {
					importHelpersImportSpecifiers = make(map[tspath.Path]*importHelpersImportSpecifier, totalFileCount)
				}
