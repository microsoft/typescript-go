...
func (p *Program) verifyCompilerOptions() {
	...
	// In TypeScript, these default to classic resolution, but the Go port doesn't support classic,
	// so they map to bundler, which would cause a spurious error here.
