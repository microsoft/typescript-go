...
func generateLocalizations(knownKeys map[string]bool, locDir string) (shared *bytes.Buffer, embed *bytes.Buffer, noembed *bytes.Buffer) {
	...
	shared.WriteString("\t\"github.com/microsoft/typescript-go/internal/json\"\n")
	shared.WriteString(")\n")
	...
	noembed.WriteString("\n")
	noembed.WriteString("\t\"github.com/microsoft/typescript-go/internal/bundled\"\n")
	noembed.WriteString("\t\"github.com/microsoft/typescript-go/internal/tspath\"\n")
	noembed.WriteString("\t\"github.com/microsoft/typescript-go/internal/vfs/osvfs\"\n")
	noembed.WriteString(")\n")
