...
func DiagnosticToLSPPull(ctx context.Context, converters *Converters, diagnostic *ast.Diagnostic) *lsproto.Diagnostic {
	...
	return diagnosticToLSP(ctx, converters, diagnostic, diagnosticCapabilities{
...
func diagnosticToLSP(ctx context.Context, converters *Converters, diagnostic *ast.Diagnostic, caps diagnosticCapabilities) *lsproto.Diagnostic {
