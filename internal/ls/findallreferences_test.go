...
class C1 extends foo().[|/*3*/B|] {}`,
   ...
   [|/*5*/foo|]([|/*6*/foo|], [|/*7*/foo|]);
			...
			expectedLocations: map[string]*core.Set[string]{
				"2": core.NewSetFromItems("2", "3", "4", "5", "6", "7"),
				"3": core.NewSetFromItems("2", "3", "4", "5", "6", "7"),
				"4": core.NewSetFromItems("2", "3", "4", "5", "6", "7"),
				"5": core.NewSetFromItems("2", "3", "4", "5", "6", "7"),
				"6": core.NewSetFromItems("2", "3", "4", "5", "6", "7"),
				"7": core.NewSetFromItems("2", "3", "4", "5", "6", "7"),
			},
		},
		{
...
a1.[|/*3*/a|];`,
			expectedLocations: map[string]*core.Set[string]{
				...
				"1": core.NewSetFromItems("1", "2"),
				"2": core.NewSetFromItems("0", "1", "2", "3"),
...
[|/*3*/let {[|/*4*/property|]: pVar} = x;|]`,
			expectedLocations: map[string]*core.Set[string]{
				"1": core.NewSetFromItems("1", "2", "4"),
				"2": core.NewSetFromItems("1", "2", "4"),
				"4": core.NewSetFromItems("1", "2", "4"),
			},
		},
		{
...
class C extends [|/*3*/Base|] { }`,
			expectedLocations: map[string]*core.Set[string]{
				"2": core.NewSetFromItems("2", "3"),
				"3": core.NewSetFromItems("2", "3"),
			},
		},
	}
