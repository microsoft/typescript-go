...
type JSDocPropertyLikeTagBase struct {
	JSDocTagBase
	name           *EntityName
	IsBracketed    bool
...
type (
	...
	JSDocParameterTagNode             = Node
	JSDocPropertyTagNode              = Node
	EndOfFile                         = Node
	DotToken                          = Node
	DotDotDotToken                    = Node
	QuestionToken                     = Node
...
func (node *JSDocParameterTag) Name() *DeclarationName {
	return node.name
}
...
func (node *JSDocPropertyTag) Name() *DeclarationName {
	return node.name
}
