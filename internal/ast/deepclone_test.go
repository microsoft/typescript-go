...
func TestDeepCloneNodeSanityCheck(t *testing.T) {
	...
	data := []struct {
		...
		{title: "TypeAssertion#1", input: `<T>a`},
		...
		{title: "PropertySignatureDeclaration#1", input: "interface I {a}"},
		{title: "PropertySignatureDeclaration#2", input: "interface I {readonly a}"},
		{title: "PropertySignatureDeclaration#3", input: "interface I {\"a\"}"},
		{title: "PropertySignatureDeclaration#4", input: "interface I {'a'}"},
		{title: "PropertySignatureDeclaration#5", input: "interface I {0}"},
		{title: "PropertySignatureDeclaration#6", input: "interface I {0n}"},
		{title: "PropertySignatureDeclaration#7", input: "interface I {[a]}"},
		{title: "PropertySignatureDeclaration#8", input: "interface I {a?}"},
		{title: "PropertySignatureDeclaration#9", input: "interface I {a: b}"},
		{title: "MethodSignatureDeclaration#1", input: "interface I {a()}"},
		{title: "MethodSignatureDeclaration#2", input: "interface I {\"a\"()}"},
		{title: "MethodSignatureDeclaration#3", input: "interface I {'a'()}"},
		{title: "MethodSignatureDeclaration#4", input: "interface I {0()}"},
		{title: "MethodSignatureDeclaration#5", input: "interface I {0n()}"},
		{title: "MethodSignatureDeclaration#6", input: "interface I {[a]()}"},
		{title: "MethodSignatureDeclaration#7", input: "interface I {a?()}"},
		{title: "MethodSignatureDeclaration#8", input: "interface I {a<T>()}"},
		{title: "MethodSignatureDeclaration#9", input: "interface I {a(): b}"},
		{title: "MethodSignatureDeclaration#10", input: "interface I {a(b): c}"},
		{title: "CallSignatureDeclaration#1", input: "interface I {()}"},
		{title: "CallSignatureDeclaration#2", input: "interface I {():a}"},
		{title: "CallSignatureDeclaration#3", input: "interface I {(p)}"},
		{title: "CallSignatureDeclaration#4", input: "interface I {<T>()}"},
		{title: "ConstructSignatureDeclaration#1", input: "interface I {new ()}"},
		{title: "ConstructSignatureDeclaration#2", input: "interface I {new ():a}"},
		{title: "ConstructSignatureDeclaration#3", input: "interface I {new (p)}"},
		{title: "ConstructSignatureDeclaration#4", input: "interface I {new <T>()}"},
