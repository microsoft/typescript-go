...
type readableBuildInfoRoot struct {
	...
	Original *BuildInfoRoot `json:"original,omitzero"`
}
...
type readableBuildInfoFileInfo struct {
	...
	Original           *BuildInfoFileInfo `json:"original,omitzero"` // Original file path, if available
}
...
type readableBuildInfoFilePendingEmit struct {
	file     string
	emitKind string
	original *BuildInfoFilePendingEmit
}
...
func (b *readableBuildInfoFilePendingEmit) UnmarshalJSON(data []byte) error {
	...
	var original *BuildInfoFilePendingEmit
	original, ok = fileIdAndEmitKind[2].(*BuildInfoFilePendingEmit)
	if !ok {
		return fmt.Errorf("invalid original in readableBuildInfoFilePendingEmit: expected *BuildInfoFilePendingEmit, got %T", fileIdAndEmitKind[2])
	}
...
type readableBuildInfoEmitSignature struct {
	...
	Original            *BuildInfoEmitSignature `json:"original,omitzero"`
}
...
func toReadableBuildInfo(buildInfo *BuildInfo, buildInfoText string) string {
...
func (r *readableBuildInfo) toFilePath(fileId BuildInfoFileId) string {
	return r.buildInfo.FileNames[fileId-1]
}

func (r *readableBuildInfo) toFilePathSet(fileIdListId BuildInfoFileIdListId) []string {
	return r.FileIdsList[fileIdListId-1]
}

func (r *readableBuildInfo) toReadableBuildInfoDiagnostic(diagnostics []*BuildInfoDiagnostic) []*readableBuildInfoDiagnostic {
	return core.Map(diagnostics, func(d *BuildInfoDiagnostic) *readableBuildInfoDiagnostic {
		var file string
		if d.File != 0 {
...
func (r *readableBuildInfo) toReadableBuildInfoDiagnosticsOfFile(diagnostics *BuildInfoDiagnosticsOfFile) *readableBuildInfoDiagnosticsOfFile {
...
func (r *readableBuildInfo) setFileInfos() {
	r.FileInfos = core.MapIndex(r.buildInfo.FileInfos, func(original *BuildInfoFileInfo, index int) *readableBuildInfoFileInfo {
		...
		return &readableBuildInfoFileInfo{
			FileName:           r.toFilePath(BuildInfoFileId(index + 1)),
...
func (r *readableBuildInfo) setRoot() {
	r.Root = core.Map(r.buildInfo.Root, func(original *BuildInfoRoot) *readableBuildInfoRoot {
		var files []string
...
func (r *readableBuildInfo) setFileIdsList() {
	r.FileIdsList = core.Map(r.buildInfo.FileIdsList, func(ids []BuildInfoFileId) []string {
...
func (r *readableBuildInfo) setSemanticDiagnostics() {
	r.SemanticDiagnosticsPerFile = core.Map(r.buildInfo.SemanticDiagnosticsPerFile, func(diagnostics *BuildInfoSemanticDiagnostic) *readableBuildInfoSemanticDiagnostic {
...
func (r *readableBuildInfo) setAffectedFilesPendingEmit() {
	...
	fullEmitKind := GetFileEmitKind(r.buildInfo.GetCompilerOptions(""))
	r.AffectedFilesPendingEmit = core.Map(r.buildInfo.AffectedFilesPendingEmit, func(pendingEmit *BuildInfoFilePendingEmit) *readableBuildInfoFilePendingEmit {
...
func toReadableFileEmitKind(fileEmitKind FileEmitKind) string {
...
func (r *readableBuildInfo) setEmitSignatures() {
	r.EmitSignatures = core.Map(r.buildInfo.EmitSignatures, func(signature *BuildInfoEmitSignature) *readableBuildInfoEmitSignature {
...
func (r *readableBuildInfo) setResolvedRoot() {
	r.ResolvedRoot = core.Map(r.buildInfo.ResolvedRoot, func(original *BuildInfoResolvedRoot) *readableBuildInfoResolvedRoot {
