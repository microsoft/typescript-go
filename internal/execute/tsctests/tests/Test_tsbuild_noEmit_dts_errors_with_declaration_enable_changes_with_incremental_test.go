...
func Test_tsbuild_noEmit_dts_errors_with_declaration_enable_changes_with_incremental(t *testing.T) {
	...
	test.Edit(&tsctests.TestEdit{
		...
		Edit: func(sys *tsctests.TestSys) {
			sys.WriteFile("/home/src/projects/project/a.ts", "const a = class { public p = 10; };")
		},
	})
