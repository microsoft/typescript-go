...
func Test_tsbuildWatch_libraryResolution_with_config_with_libReplacement(t *testing.T) {
	test := &tsctests.TestSpec{
		Scenario:        "libraryResolution",
		SubScenario:     "with config with libReplacement",
		CommandLineArgs: []string{"-b", "-w", "project1", "project2", "project3", "project4", "--verbose", "--explainFiles"},
