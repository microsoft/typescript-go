...
func Test_tsc_declarationEmit_when_same_version_is_referenced_through_source_and_another_symlinked_package(t *testing.T) {
	test := &tsctests.TestSpec{
		...
		Files: tsctests.FileMap{
			"/user/username/projects/myproject/plugin-one/action.ts": `import { actionCreatorFactory } from "typescript-fsa"; // Include version of shared lib
...
export default actionCreatorFactory;`,
    ...
    "compilerOptions": {
        ...
        "traceResolution": true,
			...
			"/user/username/projects/myproject/plugin-two/index.d.ts": `declare const _default: {
    features: {
        featureOne: {
            actions: {
                featureOne: {
