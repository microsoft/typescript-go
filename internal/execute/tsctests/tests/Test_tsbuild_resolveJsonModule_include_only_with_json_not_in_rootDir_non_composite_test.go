...
func Test_tsbuild_resolveJsonModule_include_only_with_json_not_in_rootDir_non_composite(t *testing.T) {
	test := &tsctests.TestSpec{
		Scenario:        "resolveJsonModule",
		SubScenario:     "include only with json not in rootDir non-composite",
