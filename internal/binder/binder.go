...
func (b *Binder) bindForStatement(node *ast.Node) {
	...
	if b.currentFlow == b.unreachableFlow {
		...
		breakTarget := b.createBranchLabel()
		continueTarget := b.setContinueTarget(node, b.createLoopLabel())
		b.bindIterativeStatement(stmt.Statement, breakTarget, continueTarget)
