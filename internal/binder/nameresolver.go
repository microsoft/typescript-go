...
type NameResolver struct {
	...
	OnFailedToResolveSymbol          func(location *ast.Node, nameNode *ast.Node, name string, meaning ast.SymbolFlags, nameNotFoundMessage *diagnostics.Message)
...
func (r *NameResolver) Resolve(location *ast.Node, nameNode *ast.Node, name string, meaning ast.SymbolFlags, nameNotFoundMessage *diagnostics.Message, isUse bool, excludeGlobals bool) *ast.Symbol {
	...
	if nameNotFoundMessage != nil {
		...
		if result == nil {
			if r.OnFailedToResolveSymbol != nil {
				r.OnFailedToResolveSymbol(originalLocation, nameNode, name, meaning, nameNotFoundMessage)
			}
		} else {
