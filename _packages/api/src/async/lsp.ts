...
export function startLSPServer(executable: string, cwd: string): ChildProcessByStdio<Writable, Readable, null> {
...
export function createJSONRPCClient(serverProcess: ChildProcessByStdio<Writable, Readable, null>, onError: (error: LSPError) => void): JSONRPCClient {
