...
const visitEachChildTable: Record<number, VisitEachChildFunction> = {
    ...
    [SyntaxKind.FunctionDeclaration]: (node: FunctionDeclaration, visitor: Visitor): FunctionDeclaration => {
        ...
        const _type = visitNode(node.type, visitor, isTypeNode);
        const _fullSignature = visitNode(node.fullSignature, visitor, isTypeNode);
        const _body = visitNode(node.body, visitor, isFunctionBody);
        return updateFunctionDeclaration(node, _modifiers, _asteriskToken, _name, _typeParameters, _parameters, _type, _fullSignature, _body);
    },
    ...
    [SyntaxKind.Constructor]: (node: ConstructorDeclaration, visitor: Visitor): ConstructorDeclaration => {
        ...
        const _fullSignature = visitNode(node.fullSignature, visitor, isTypeNode);
        const _body = visitNode(node.body, visitor, isFunctionBody);
        return updateConstructorDeclaration(node, _modifiers, _typeParameters, _parameters, _type, _fullSignature, _body);
    },
    [SyntaxKind.GetAccessor]: (node: GetAccessorDeclaration, visitor: Visitor): GetAccessorDeclaration => {
        ...
        const _fullSignature = visitNode(node.fullSignature, visitor, isTypeNode);
        const _body = visitNode(node.body, visitor, isFunctionBody);
        return updateGetAccessorDeclaration(node, _modifiers, _name, _typeParameters, _parameters, _type, _fullSignature, _body);
    },
    [SyntaxKind.SetAccessor]: (node: SetAccessorDeclaration, visitor: Visitor): SetAccessorDeclaration => {
        ...
        const _fullSignature = visitNode(node.fullSignature, visitor, isTypeNode);
        const _body = visitNode(node.body, visitor, isFunctionBody);
        return updateSetAccessorDeclaration(node, _modifiers, _name, _typeParameters, _parameters, _type, _fullSignature, _body);
    },
    ...
    [SyntaxKind.MethodDeclaration]: (node: MethodDeclaration, visitor: Visitor): MethodDeclaration => {
        ...
        const _fullSignature = visitNode(node.fullSignature, visitor, isTypeNode);
        const _body = visitNode(node.body, visitor, isFunctionBody);
        return updateMethodDeclaration(node, _modifiers, _asteriskToken, _name, _postfixToken, _typeParameters, _parameters, _type, _fullSignature, _body);
    },
    ...
    [SyntaxKind.ArrowFunction]: (node: ArrowFunction, visitor: Visitor): ArrowFunction => {
        ...
        return updateArrowFunction(node, _modifiers, _typeParameters, _parameters, _type, _fullSignature, _equalsGreaterThanToken, _body);
    },
    [SyntaxKind.FunctionExpression]: (node: FunctionExpression, visitor: Visitor): FunctionExpression => {
        ...
        const _fullSignature = visitNode(node.fullSignature, visitor, isTypeNode);
        const _body = visitNode(node.body, visitor, isFunctionBody);
        return updateFunctionExpression(node, _modifiers, _asteriskToken, _name, _typeParameters, _parameters, _type, _fullSignature, _body);
    },
    ...
    [SyntaxKind.JSDocSignature]: (node: JSDocSignature, visitor: Visitor): JSDocSignature => {
        const _typeParameters = visitNodesArray(node.typeParameters, visitor);
        const _parameters = visitNodesArray(node.parameters, visitor);
        const _type = visitNode(node.type, visitor, isTypeNode);
    ...
    [SyntaxKind.JSDocPropertyTag]: (node: JSDocPropertyTag, visitor: Visitor): JSDocPropertyTag => {
        const _tagName = visitNode(node.tagName, visitor, isIdentifier);
        const _name = visitNode(node.name, visitor, isEntityName);
        const _typeExpression = visitNode(node.typeExpression, visitor, isTypeNode);
        const _comment = visitNodes(node.comment, visitor);
