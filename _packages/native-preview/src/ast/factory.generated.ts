...
function cloneNodeData(node: Node): any {
    ...
    switch (node.kind) {
        ...
        case SyntaxKind.ModuleDeclaration:
            return { modifiers: n.modifiers, keyword: n.keyword, name: n.name, body: n.body, attributes: n.attributes };
...
export function createModuleDeclaration(modifiers: readonly ModifierLike[] | undefined, keyword: SyntaxKind.ModuleKeyword | SyntaxKind.NamespaceKeyword, name: ModuleName, body?: ModuleBody, attributes?: TypeLiteralNode): ModuleDeclaration {
...
export function updateModuleDeclaration(node: ModuleDeclaration, modifiers: readonly ModifierLike[] | undefined, name: ModuleName, body?: ModuleBody, attributes?: TypeLiteralNode): ModuleDeclaration {
    return node.modifiers !== modifiers || node.name !== name || node.body !== body || node.attributes !== attributes ? createModuleDeclaration(modifiers, node.keyword, name, body, attributes) : node;
}
